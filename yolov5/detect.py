...
# Some YOLOv5 .pt checkpoints saved on Linux contain PosixPath objects.
# This monkey-patch maps them to WindowsPath when running on Windows.
if os.name == "nt":
...
def parse_opt():
    ...
    parser.add_argument("--save-format", type=int, default=0, help="YOLO(0) or Pascal-VOC(1) format when saving txt")
